...
import { ChevronLeft, Share2, Printer, Activity, Target, Zap } from 'lucide-react';
...
export const PlayerDetail = () => {
    ...
    const [fitnessPbs, setFitnessPbs] = useState<FitnessPBs | null>(null);
            ...
            <div className="flex gap-1 p-1 bg-gray-100/50 rounded-2xl w-fit">
                <button
                    ...
                    className={clsx(
                        ...
                        activeTab === 'overview' ? "bg-white text-hfc-brown shadow-sm" : "text-gray-500 hover:text-gray-700 hover:bg-white/50"
                    )}
                >
                    <Target size={18} />
                    Overview
                ...
                <button
                    ...
                    className={clsx(
                        "flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold transition-all",
                        activeTab === 'fitness' ? "bg-white text-hfc-brown shadow-sm" : "text-gray-500 hover:text-gray-700 hover:bg-white/50"
                    )}
                >
                    <Zap size={18} />
                    Fitness Performance
